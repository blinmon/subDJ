...
class UserManagement {
	 ...
	 * @returns {object} Returns a <subsonic-response> element with a nested <user> element on success.
	 */
	 ...
	 * @param   {object} auth Authenticate Object.
	 * @returns {object} Returns a <subsonic-response> element with a nested <users> element on success.
	 */
	getUsers(auth) {
		var result;
		return result;
	 ...
	 */
	createUser(auth, username, password, email, ldapAuthenticated = false, adminRole = false, settingsRole = true, streamRole = true, jukeboxRole = false, downloadRole = false, uploadRole = false, playlistRole = false, coverArtRole = false, commentRole = false, podcastRole = false, shareRole = false, videoConversionRole = false, musicFolderId) {
		var result;
		return result;
	}
	 ...
	 * @returns {object}  Returns an empty <subsonic-response> element on success.
	 */
	updateUser(auth, username, password, email, ldapAuthenticate, adminRole, settingsRole, streamRole, jukeboxRole, downloadRole, uploadRole, coverArtRole, commentRole, podcastRole, shareRole, videoConversionRole, musicFolderId, maxBitRate) {
		var result;
		return result;
	}
	 ...
	 * @returns {object} Returns an empty <subsonic-response> element on success.
	 */
	changePassword(auth, username, password) {
		var result;
		return result;
	}
}
