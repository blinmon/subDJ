...
class Album {
	 ...
	 * @returns {object} Returns a <subsonic-response> element with a nested <albumList> element on success.
	 */
	getAlbumList(auth, type, size = 10, offset = 0, fromYear, toYear, genre, musicFolderId) {
		var result;
		return result;
	}
	 ...
	 * @returns {object} Returns a <subsonic-response> element with a nested <albumList2> element on success.
	 */
	getAlbumList2(auth, type, size = 10, offset = 0, fromYear, toYear, genre, musicFolderId) {
		var result;
		return result;
	}
	 ...
	 */
	getRandomSongs(auth, size = 10, genre, fromYear, toYear, musicFolderId) {
		var result;
		return result;
	}
	 ...
	 */
	getSongsByGenre(auth, genre, count = 10, offset = 0, musicFolderId) {
		var result;
		return result;
	}
	 ...
	 */
	getStarred2(auth, musicFolderId) {
		var result;
		return result;
	}
}
